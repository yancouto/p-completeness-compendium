...
The reduction is from [AGG]({{< relref "./a-11-3.md" >}}).
The game *Shortcake* is the same as Longcake except the larger portion of the current submatrix is thrown away. Shortcake is complete for $\mathsf{AC}^1$ <a href="#ref-1" class="reference-citation">[1]</a>. Another variant of these games called *Semicake* is complete for $\mathsf{LOGCFL} = \mathsf{SAC}^1$ <a href="#ref-1" class="reference-citation">[1]</a>.
