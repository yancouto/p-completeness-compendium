...
The game *Shortcake* is the same as Longcake except the larger portion of the current submatrix is thrown away. Shortcake is complete for $\mathsf{AC}^1$ [1]. Another variant of these games called *Semicake* is complete for $\mathsf{LOGCFL} = \mathsf{SAC}^1$ [1].
