...
Luks showed the problem is in $\P$ [1]. Without the degree bound, the problem is in $\NP$ but not known to be in $\P$, nor is it known to be either $\P$-hard or $\NP$-complete. Lindell shows that the *Tree Isomorphism* Problem is in $\NC$. *Subtree Isomorphism* is in $\mathsf{RNC}$ (Gibbons et al. [2], Lingas and Karpinski [3]). See [STI]({{< relref "./b-9-9.md" >}}) for additional details.
