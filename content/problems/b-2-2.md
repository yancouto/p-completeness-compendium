...
There is a polylogarithmic algorithm that uses $n(\log n)^{O(1)}$ processors on a CREW-PRAM [[1]](#1). See also Problems [LI]({{< relref "./a-4-1.md" >}}), [LE]({{< relref "./a-4-2.md" >}}), [LP]({{< relref "./a-4-3.md" >}}) and [Opt2ILP]({{< relref "./b-2-1.md" >}}).
