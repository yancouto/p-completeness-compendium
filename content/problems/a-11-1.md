...
The reduction is from [GEN]({{< relref "./a-6-7.md" >}}) [[1]](#1) or [AM2CVP]({{< relref "./a-1-4.md" >}}) [[3]](#3). Since GAME is an instance of AND/OR Graph Solvability, it follows that determining whether an AND/OR graph has a solution is also $\P$-complete (Kasif [[2]](#2)).
