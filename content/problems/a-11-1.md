...
$\P$-complete (Jones and Laaser <a href="#ref-1" class="reference-citation">[1]</a>, Greenlaw, Hoover, and Ruzzo <a href="#ref-3" class="reference-citation">[3]</a>).

## Remarks

The reduction is from [GEN]({{< relref "./a-6-7.md" >}}) <a href="#ref-1" class="reference-citation">[1]</a> or [AM2CVP]({{< relref "./a-1-4.md" >}}) <a href="#ref-3" class="reference-citation">[3]</a>. Since GAME is an instance of AND/OR Graph Solvability, it follows that determining whether an AND/OR graph has a solution is also $\P$-complete (Kasif <a href="#ref-2" class="reference-citation">[2]</a>).
