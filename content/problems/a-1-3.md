...
$\P$-complete under $\NC^1$ reductions (Greenlaw, Roover and Ruzzo  <a href="#ref-3" class="reference-citation">[3, Theorem 6.2.2]</a>, Goldschlager <a href="#ref-1" class="reference-citation">[1]</a>).

## Remarks

Vitter and Simmons give a $\sqrt{n}$ time parallel algorithm for the non-sparse version of the problem <a href="#ref-2" class="reference-citation">[2]</a>.
