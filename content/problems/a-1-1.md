...
The CVP is the most fundamental $\P$-complete problem, in fact, its one of the few where $\P$-completeness is proved directly (from [GMSP]({{< relref "./a-12-1.md" >}})) instead of through reductions from other $\P$-complete problems.
