...
$\P$-complete (Denenberg <a href="#ref-1" class="reference-citation">[1]</a>).

## Remarks

The reduction to show hardness is from [HORN]({{< relref "./a-6-2.md" >}}).