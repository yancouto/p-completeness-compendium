...
It is easy to see that the plane sweep triangulation algorithm runs in polynomial time. The reduction to show hardness is from a variant of [PCVP]({{< relref "./a-1-7.md" >}}).
