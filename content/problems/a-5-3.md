...
P-complete problem from Greenlaw et al. (1995), Problem A.5.3.

## Remarks

The weighted version of the problem in which each clause is given an integer weight coded in binary is PLS-complete [278, 324]. If the weights are encoded in unary, the problem is FP-complete.
