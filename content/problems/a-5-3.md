...
The weighted version of the problem in which each clause is given an integer weight coded in binary is $\mathsf{PLS}$-complete [1][2]. If the weights are encoded in unary, the problem is $\mathsf{FP}$-complete.
