...
Since the weights are one, the range of solution values is polynomial and the problem is in $\P$. The reduction presented in [[3]](#3) is from a variant of [MCVP]({{< relref "./a-1-3.md" >}}).
