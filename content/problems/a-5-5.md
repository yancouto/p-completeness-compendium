...
$\P$-complete problem from Greenlaw et al. (1995), Problem A.5.5.

## Remarks

The weighted version of the problem in which each edge is given an integer weight encoded in binary is PLS-complete [278, 324]. If the edge weights are encoded in unary, the problem is FP- complete.
