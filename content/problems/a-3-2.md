...
The construction of maximal sets of vertex disjoint paths is important for developing fast, parallel, randomized algorithms for depth-first search (Aggarwal and Anderson [[2]](#2), Aggarwal, Anderson, and Kao [[3]](#3)). See [DFS]({{< relref "./b-9-2.md" >}}) and [MDP]({{< relref "./b-9-5.md" >}}).
