...
In the origimal paper for the $\P$-completeness, the problem is stated as here (except it's called HDS), while in [[5]](#5) the task is to decide whether a non-empty $k$-core exists (we shall hence refer to this as NE-k-Core). These are slightly different variants, but both are shown to be $\P$-complete in [[1]](#1).
