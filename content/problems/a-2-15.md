...
The *nearest merger*, *nearest insertion*, *cheapest insertion*, and *farthest insertion* heuristics are all $\P$-complete [[1]](#1). The *double minimum spanning tree* and *nearest addition* heuristics are in $\NC$ [[1]](#1). See [TS2Opt]({{< relref "./a-5-9.md" >}}).