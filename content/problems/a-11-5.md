...
$\P$-complete (Berlekamp, Conway, and Guy [1, pages 817--850], Greenlaw, Hoover, and Ruzzo [2]).

## Remarks

Berlekamp, Conway, and Guy sketch a reduction that the Game of Life is capable of universal computation and [2] translates it into the statement of a $\P$-complete problem from [CVP]({{< relref "./a-1-1.md" >}}).
