...
See [LFMIS]({{< relref "./a-2-1.md" >}}). Finding the lexicographically first maximal subgraph of maximum degree one in planar, bipartite graphs of degree at most three is $\P$-complete [[1]](#1).
