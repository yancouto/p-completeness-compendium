...
The Fill Slots procedure is similar to one used in [1] to prove that the *Edge Ranking Problem* is in $\P$. The result suggests that their algorithm may not parallelize well. FILL seems interesting because it involves only Boolean values. Additional details can be found in de la Torre, Greenlaw, and Schäffer [2]. Also, see [ER]({{< relref "./b-1-2.md" >}}).
