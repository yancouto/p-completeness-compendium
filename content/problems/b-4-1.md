...
Open (Àlvarez et al. <a href="#ref-1" class="reference-citation">[1]</a>, Balcázar, Gabarró, and Sántha <a href="#ref-2" class="reference-citation">[2]</a>)

## Remarks

The problem is $\P$-complete if the system is allowed to be nondeterministic <a href="#ref-2" class="reference-citation">[2]</a>, see [SBTS]({{< relref "./a-7-10.md" >}}). The complexity of the problem is also open if states are restricted to have indegree one <a href="#ref-2" class="reference-citation">[2]</a>.
