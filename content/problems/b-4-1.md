...
The problem is $\P$-complete if the system is allowed to be nondeterministic [1], see SBTS. The complexity of the problem is also open if states are restricted to have indegree one [1].
