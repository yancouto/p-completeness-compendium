...
The problem is $\P$-complete if the system is allowed to be nondeterministic [[2]](#2), see [SBTS]({{< relref "./a-7-10.md" >}}). The complexity of the problem is also open if states are restricted to have indegree one [[2]](#2).
