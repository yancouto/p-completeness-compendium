...
The complexity of the 2-oriented version of the problem is open [1]. In [1] they remark that the problem has been reduced to an instance of [MCVP]({{< relref "./a-1-3.md" >}}) that has a very restricted topology, although not planar. Thus, it is open whether or not this version of the problem is in $\NC$.
