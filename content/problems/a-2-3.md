...
Yasuura shows a generalization of AGAP is $\P$-complete via a reduction to Path Systems ([PATH]({{< relref "./a-6-8.md" >}})) [[7]](#7). He considers the graph reachability problem on directed *hypergraphs*, graphs whose edges consist of a subset of vertices and a single vertex.
