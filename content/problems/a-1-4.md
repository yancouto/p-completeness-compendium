...
$\P$-complete under $\NC^1$ reductions (Greenlaw, Roover and Ruzzo <a href="#ref-2" class="reference-citation">[2, Theorem 6.2.3]</a>).

## Remarks

Goldschlager, Shaw, and Staples gave a $\P$-completeness proof for Monotone, Fanout 2 [CVP]({{< relref "./a-1-1.md" >}}) <a href="#ref-1" class="reference-citation">[1]</a>.
