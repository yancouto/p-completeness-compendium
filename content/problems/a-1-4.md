...
$\P$-complete under $\NC^1$ reductions (Greenlaw, Roover and Ruzzo [2, Theorem 6.2.3]).

## Remarks

Goldschlager, Shaw, and Staples gave a $\P$-completeness proof for Monotone, Fanout 2 [CVP]({{< relref "./a-1-1.md" >}}) [1].
