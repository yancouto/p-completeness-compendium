...
P-complete problem from Greenlaw et al. (1995), Problem A.2.4.

## Remarks

Hierarchical versions of the following problems are also P-complete: graph accessibility in undirected graphs, determining whether a directed graph contains a cycle, and determining whether a given graph is bipartite. There are several other very restricted versions of hierarchical graph problems that are P-complete. See the references for details.
