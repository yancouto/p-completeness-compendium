...
There is a polynomial time algorithm for the problem that uses dynamic programming (Howard [[2]](#2)). The reduction to show hardness is from [MCVP]({{< relref "./a-1-3.md" >}}).
