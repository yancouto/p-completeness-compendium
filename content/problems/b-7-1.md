...
Lenstra, Lenstra, and Lovász show that the problem is in $\P$ [[2]](#2). [IntegerGCD]({{< relref "./b-5-3.md" >}}) is $\NC^1$ reducible to SV [[1]](#1). For additional remarks about related problems, see Bachem and Kannan [[3]](#3).