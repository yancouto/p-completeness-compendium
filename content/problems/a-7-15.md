...
$\P$-complete (Shoudai <a href="#ref-1" class="reference-citation">[1]</a>).
...
It is known that there are two deterministic context-free languages whose shuffle is $\NP$-complete (Ogden, Riddle, and Rounds <a href="#ref-2" class="reference-citation">[2]</a>). Here the intersection operation is used to force the problem into $\P$ <a href="#ref-1" class="reference-citation">[1]</a>.
