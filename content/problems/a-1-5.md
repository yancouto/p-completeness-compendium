...
$\P$-complete under $\NC^1$ reductions (Greenlaw, Roover and Ruzzo <a href="#ref-2" class="reference-citation">[2, Theorem 6.2.4]</a>).

## Remarks

Any complete basis of gates suffices, by the obvious simulation of NAND gates in the other basis. For example, NOR gates form a complete basis. NORCVP is defined analogously to NANDCVP. See Post for a characterization of complete bases <a href="#ref-1" class="reference-citation">[1]</a>. See the remarks for [CVP]({{< relref "problems/a-1-1.md" >}}) for other bases, not necessarily complete, for which the associated Circuit Value Problem is still complete.
