...
A polynomial time algorithm for the problem is given in [[1]](#1). The reduction is from the *Implication Problem for Propositional Horn Clauses* (Jones and Laaser [[2]](#2)). See Problems [UNIT]({{< relref "./a-6-1.md" >}}) and [HORN]({{< relref "./a-6-2.md" >}}).
