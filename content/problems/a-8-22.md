...
A polynomial time algorithm for the problem is given in <a href="#ref-1" class="reference-citation">[1]</a>. The reduction is from the *Implication Problem for Propositional Horn Clauses* (Jones and Laaser <a href="#ref-2" class="reference-citation">[2]</a>). See Problems [UNIT]({{< relref "./a-6-1.md" >}}) and [HORN]({{< relref "./a-6-2.md" >}}).
