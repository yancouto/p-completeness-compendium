...
$\P$-complete (Àlvarez et al <a href="#ref-1" class="reference-citation">[1]</a>, Balcázar, Gabarró, and Sántha <a href="#ref-2" class="reference-citation">[2]</a>).

## Remarks

The reduction to show hardness is from [SAM2CVP]({{< relref "./a-1-6.md" >}}), and in it the transition system is nondeterministic. It is an open question whether the problem remains $\P$-complete in the deterministic case <a href="#ref-2" class="reference-citation">[2]</a>, see [SBDTS]({{< relref "./b-4-1.md" >}}). *Observation Equivalence* and *Observation Congruence* are two related problems that are both shown $\P$-complete in <a href="#ref-2" class="reference-citation">[2]</a>. Zhang and Smolka implement parallel algorithms for equivalence checking <a href="#ref-3" class="reference-citation">[3]</a>.
