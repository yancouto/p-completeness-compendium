...
The visibility layering process can be performed in polynomial time [[2]](#2). The reduction to show hardness is from a topologically ordered variant of [MCVP]({{< relref "./a-1-3.md" >}}).
