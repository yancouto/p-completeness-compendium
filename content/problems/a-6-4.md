...
An algorithm showing the problem is in P is given in [1].
The reduction to show hardness is from a Nonacceptance Problem for Pushdown Automata (Denenberg [[2]](#2)[[1]](#1)), see [2DPDA]({{< relref "./a-7-8.md" >}}).
